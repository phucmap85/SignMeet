...
# wordlist = {'hello', 'you', 'me', 'thank you', 'and', 'name', 'tomorrow', 'yesterday', 
#             'today', 'what', 'where', 'how', 'when', 'who', 'why', 'fine', 'bad'}
...
with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
    ...
    while cap.isOpened():
        ...
        if(rh[12][0] >= lip_x_min and rh[12][0] <= lip_x_max and rh[12][1] >= lip_y_min and rh[12][1] <= lip_y_max):
        ...
        if on_lip:
            ...
            if(len(lm_arr) > 0):
                data_path = path + '/' + str(datetime.now().strftime("%d-%m-%Y_%H.%M.%S"))
